  ...
  return (
    ...
    <div className='results-container'>
      <div className='result-card' >
        ...
        {type === 'add' &&
          <div className='controls' style={{ marginLeft: '1px' }}>
            <button className='btn btn-success' style={{}} disabled={watchlistDisabled}
              onClick={(event) => {
                event.preventDefault();
                AddMovieToWatchlist(movie);
              }}>
              <h2 style={{ fontSize: '10px' }}>Watchlist</h2>
            </button>

            <button className='btn btn-success' disabled={watchedDisabled}
              onClick={(event) => {
                event.preventDefault();
                AddMovieToWatched(movie);
              }}>
              <h2 style={{ fontSize: '10px' }}>Watched</h2>
            </button>
            <button className='btn btn-success' disabled={watchedDisabled}
              onClick={(event) => {
                event.preventDefault();
              ...
              <h2 style={{ fontSize: '10px' }}>Favorite</h2>
            </button>
          </div>
        }
